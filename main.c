...
/*   Updated: 2019/11/15 16:21:38 by tbigot           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main()
{
	...
	i = printf("Vrai : i-> %011.7i\n", ' ');
	j = ft_printf("Faux : i-> %011.7i\n", ' ');
	if (i != j)
		printf(R"PAS DE CHANCE %d != %d\n\n"S, i, j);
	else
		printf(G"GG %d == %d\n\n"S, i, j);
...
/*	i = printf("Vrai : X-> %s\n", 16);
	...
	if (i != j)
		...
		printf(G"GG %d == %d\n\n"S, i, j);
	i = printf("Vrai : s-> %00000000z test");
	printf("\n");
	j = ft_printf("Faux : s-> %000000000z test");
	ft_printf("\n");
	if (i != j)
